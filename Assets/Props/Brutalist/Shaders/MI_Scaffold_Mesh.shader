Shader "Unreal/MI_Scaffold_Mesh"
{
	Properties
	{
		...
		Material_Texture2D_7( "L2MasksT", 2D ) = "white" {}
		Material_Texture2D_8( "T_Cloud_M", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,2.000000,3.000000,0.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(5.554473,2.777236,-2.215242,-4.992478);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1024.000000,1024.000000,-1024.000000,-0.000977);//(Unknown)
	Material.PreshaderBuffer[4] = float4(2.624648,1.015606,2.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.123602,0.291667,0.256573,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.123602,0.291667,0.256573,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.123602,0.291667,0.256573,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.123602,0.291667,0.256573,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[12] = float4(0.372917,0.370441,0.358912,1.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local12), 10);
	...
	MaterialFloat3 Local16 = lerp(Local14.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[1].w);
	MaterialFloat3 Local17 = mul(Local11, Parameters.TangentToWorld);
	MaterialFloat3 Local18 = normalize(Local17);
	MaterialFloat Local19 = dot(Local18,normalize(MaterialFloat3(0.00000000,0.00000000,1.00000000)));
	MaterialFloat Local20 = (Local19 * 0.50000000);
	MaterialFloat Local21 = (Local20 + 0.50000000);
	MaterialFloat Local22 = (Local21 * Material.PreshaderBuffer[2].x);
	MaterialFloat Local23 = (Local22 + Material.PreshaderBuffer[2].w);
	MaterialFloat Local24 = saturate(Local23);
	FLWCVector3 Local25 = GetWorldPosition_NoMaterialOffsets(Parameters);
	FLWCVector3 Local26 = LWCMultiply(DERIV_BASE_VALUE(Local25), LWCPromote(((MaterialFloat3)Material.PreshaderBuffer[3].w)));
	...
	MaterialFloat4 Local44 = Texture2DSample(Material_Texture2D_3,GetMaterialSharedSampler(Material_Texture2D_3Sampler,View.MaterialTextureBilinearWrapedSampler),Local42);
	...
	MaterialFloat3 Local50 = (Local49 * ((MaterialFloat3)Material.PreshaderBuffer[4].x));
	MaterialFloat3 Local51 = PositiveClampedPow(Local50,((MaterialFloat3)Material.PreshaderBuffer[4].y));
	MaterialFloat3 Local52 = saturate(Local51);
	MaterialFloat Local53 = PositiveClampedPow(Local52.r,Material.PreshaderBuffer[4].z);
	MaterialFloat Local54 = saturate(Local53);
	MaterialFloat Local55 = (Local24 - Local54);
	MaterialFloat Local56 = saturate(Local55);
	MaterialFloat Local57 = saturate(Local56);
	MaterialFloat3 Local58 = lerp(Local11,Local16,Local57);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local58.rgb;
	...
	MaterialFloat3 Local59 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[5].xyz,Material.PreshaderBuffer[4].w);
	MaterialFloat Local60 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local61 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local62 = MaterialStoreTexSample(Parameters, Local61, 0);
	MaterialFloat Local63 = dot(Local61.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local64 = (Material.PreshaderBuffer[7].xyz * ((MaterialFloat3)Local63));
	MaterialFloat Local65 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local66 = Texture2DSampleBias(Material_Texture2D_5,Material_Texture2D_5Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local67 = MaterialStoreTexSample(Parameters, Local66, 1);
	MaterialFloat3 Local68 = lerp(Local61.rgb,Local64,Local66.a);
	MaterialFloat Local69 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 0);
	MaterialFloat4 Local70 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_6,Material_Texture2D_6Sampler,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local73 = (Material.PreshaderBuffer[9].xyz * ((MaterialFloat3)Local72));
	MaterialFloat Local74 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 1);
	MaterialFloat4 Local75 = Texture2DSampleBias(Material_Texture2D_7,Material_Texture2D_7Sampler,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias);
	MaterialFloat Local76 = MaterialStoreTexSample(Parameters, Local75, 1);
	MaterialFloat3 Local77 = lerp(Local70.rgb,Local73,Local75.a);
	MaterialFloat3 Local78 = lerp(Local68,Local77,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local79 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local12), 11);
	MaterialFloat4 Local80 = Texture2DSampleBias(Material_Texture2D_8,Material_Texture2D_8Sampler,DERIV_BASE_VALUE(Local12),View.MaterialTextureMipBias);
	...
	MaterialFloat3 Local83 = lerp(Local78,Local82,Local57);
	MaterialFloat Local84 = lerp(Local66.r,Local75.r,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local85 = lerp(Local84,0.00000000,Local57);
	MaterialFloat Local86 = lerp(Local66.g,Local75.g,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local87 = lerp(Local86,Material.PreshaderBuffer[12].w,Local57);
	MaterialFloat Local88 = lerp(Local61.a,Local70.a,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local89 = lerp(Local66.b,Local75.b,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local90 = lerp(Local89,1.00000000,Local57);

	PixelMaterialInputs.EmissiveColor = Local59;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local88;
	PixelMaterialInputs.BaseColor = Local83.rgb;
	PixelMaterialInputs.Metallic = Local85.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local87.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local58.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local90.r;
