...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(-1500.000000,-0.000667,1.855161,0.899354);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.950898,1.000000,0.947918,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.950898,1.000000,0.947918,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.427083,0.427083,0.427083,1.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.427083,0.427083,0.427083,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.750000,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Normal = Local47.rgb;
	...
	MaterialFloat3 Local48 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[4].xyz,Material.PreshaderBuffer[3].y);
	MaterialFloat Local49 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local50 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local51 = MaterialStoreTexSample(Parameters, Local50, 0);
	MaterialFloat Local52 = dot(Local50.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local53 = (Material.PreshaderBuffer[6].xyz * ((MaterialFloat3)Local52));
	MaterialFloat3 Local54 = (Material.PreshaderBuffer[8].xyz * Local53);
	MaterialFloat3 Local55 = lerp(Local53,Local54,Local46);

	PixelMaterialInputs.EmissiveColor = Local48;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local55.rgb;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[8].w.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[9].x.r;
