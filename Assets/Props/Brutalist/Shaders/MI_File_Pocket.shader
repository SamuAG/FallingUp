Shader "Unreal/MI_File_Pocket"
{
	Properties
	{
		...
		Material_Texture2D_2( "RandomColorPalette", 2D ) = "white" {}
		Material_Texture2D_3( "L1MasksT", 2D ) = "white" {}
		Material_Texture2D_4( "L2AlbedoT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.000000,0.850000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local7 = lerp(Local3.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),DERIV_BASE_VALUE(Local6));
	...
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 0);
	MaterialFloat Local12 = (GetPerInstanceRandom(Parameters) * 3.00000000);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local12,0.50000000), 5);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,MaterialFloat2(Local12,0.50000000),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 5);
	MaterialFloat Local16 = dot(Local10.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local17 = (Local14.rgb * ((MaterialFloat3)Local16));
	MaterialFloat Local18 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local19 = Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local20 = MaterialStoreTexSample(Parameters, Local19, 1);
	MaterialFloat3 Local21 = lerp(Local10.rgb,Local17,Local19.a);
	MaterialFloat2 Local22 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[2].w));
	MaterialFloat Local23 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local22), 0);
	MaterialFloat4 Local24 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local22),View.MaterialTextureMipBias));
	MaterialFloat Local25 = MaterialStoreTexSample(Parameters, Local24, 0);
	MaterialFloat3 Local26 = lerp(Local21,Local24.rgb,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local27 = lerp(Local19.r,Material.PreshaderBuffer[3].x,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local28 = lerp(Local19.g,Material.PreshaderBuffer[3].y,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local29 = lerp(Local19.b,1.00000000,DERIV_BASE_VALUE(Local6));

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local26.rgb;
	PixelMaterialInputs.Metallic = Local27.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local28.r;
