Shader "Unreal/MI_Pine_Tall_Billboard"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.567708,0.459709,0.260200,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.567708,0.459709,0.260200,0.450000);//(Unknown)
