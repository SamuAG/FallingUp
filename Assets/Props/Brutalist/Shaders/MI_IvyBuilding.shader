...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(1.000000,1.200000,1.200000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,1.200000,1.200000,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.450280,0.910035,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.450280,0.910035,1.000000,2.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.000000,0.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local12 = (Local3.rgb * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000),Parameters.TwoSidedSign));
	MaterialFloat3 Local13 = mul(Local12, Parameters.TangentToWorld);
	MaterialFloat Local14 = dot(Parameters.CameraVector,Local13);
	MaterialFloat Local15 = saturate(Local14);
	MaterialFloat Local16 = (Local15 * Material.PreshaderBuffer[6].w);
	MaterialFloat Local17 = (1.00000000 - Local16);
	MaterialFloat Local18 = (Local17 + 0.00000000);
	MaterialFloat3 Local19 = (((MaterialFloat3)Local18) * Local11);
	MaterialFloat Local20 = dot(Local11,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local21 = lerp(Local11,((MaterialFloat3)Local20),Material.PreshaderBuffer[7].x);
	MaterialFloat3 Local22 = (Local21 * Material.PreshaderBuffer[9].xyz);
	MaterialFloat Local23 = (1.00000000 - Local15);
	MaterialFloat Local24 = PositiveClampedPow(Local23,Material.PreshaderBuffer[9].w);
	MaterialFloat Local25 = (Local24 * Material.PreshaderBuffer[10].x);
	MaterialFloat Local26 = saturate(Local25);
	MaterialFloat3 Local27 = lerp(Local19,Local22,Local26);
	MaterialFloat Local28 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local29 = Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local30 = MaterialStoreTexSample(Parameters, Local29, 1);
	MaterialFloat3 Local31 = lerp(Local11,Local27,Local29.r);
	MaterialFloat Local32 = PositiveClampedPow(Local29.g,Material.PreshaderBuffer[10].z);
	MaterialFloat Local33 = (Material.PreshaderBuffer[10].w * Local29.r);
	MaterialFloat Local34 = PositiveClampedPow(Local29.r,Material.PreshaderBuffer[11].x);
	MaterialFloat3 Local35 = lerp(((MaterialFloat3)0.00000000),Local11,Local34);
	MaterialFloat3 Local36 = (Local35 * Material.PreshaderBuffer[13].xyz);
	MaterialFloat Local37 = (Local29.b * Material.PreshaderBuffer[14].x);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = Local33;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local36,Material.PreshaderBuffer[13].w);
