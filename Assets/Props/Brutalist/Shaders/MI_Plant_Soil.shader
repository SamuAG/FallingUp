...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(2.000000,0.300000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.900000,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.BaseColor = Local15.rgb.rgb;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[2].w.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[3].x.r;
