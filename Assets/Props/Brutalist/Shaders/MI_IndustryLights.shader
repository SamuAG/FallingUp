Shader "Unreal/MI_IndustryLights"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "NormalT", 2D ) = "white" {}
		Material_Texture2D_1( "MasksT", 2D ) = "white" {}
		Material_Texture2D_2( "AlbedoT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,0.745912,0.496109,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,0.745912,0.496109,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.588542,0.189357,0.047063,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.588542,0.189357,0.047063,1.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local6 = Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local7 = MaterialStoreTexSample(Parameters, Local6, 1);
	MaterialFloat3 Local8 = (Material.PreshaderBuffer[3].xyz * ((MaterialFloat3)Local6.a));
	MaterialFloat3 Local9 = (Local8 * ((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat3 Local10 = lerp(Local9.rgb,Material.PreshaderBuffer[4].yzw,Material.PreshaderBuffer[4].x);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 0);
	MaterialFloat3 Local14 = (Material.PreshaderBuffer[6].xyz * Local12.rgb);
	MaterialFloat4 Local15 = Parameters.VertexColor;
	MaterialFloat Local16 = DERIV_BASE_VALUE(Local15).r;
	MaterialFloat3 Local17 = lerp(Local12.rgb,Local14,DERIV_BASE_VALUE(Local16));
	MaterialFloat Local18 = (Local6.g * Material.PreshaderBuffer[6].w);
	MaterialFloat Local19 = PositiveClampedPow(Local18,Material.PreshaderBuffer[7].x);

	PixelMaterialInputs.EmissiveColor = Local10;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local17.rgb;
	PixelMaterialInputs.Metallic = Local6.r.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local19.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local3.rgb.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local6.b.r;
