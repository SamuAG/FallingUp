Shader "Unreal/M_Showcase_Floor"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_Detail_Metal_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Floor_M", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(30.000000,3500.000000,0.000286,1.580842);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.300000,20.000000,2.000000,0.388662);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.285715,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local6 = lerp(Local3.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),0.94999999);
	FLWCVector3 Local7 = GetWorldPosition(Parameters);
	FLWCVector3 Local8 = ResolvedView.WorldCameraOrigin;
	FLWCVector3 Local9 = LWCSubtract(DERIV_BASE_VALUE(Local7), Local8);
	MaterialFloat3 Local10 = LWCToFloat(DERIV_BASE_VALUE(Local9));
	MaterialFloat Local11 = length(DERIV_BASE_VALUE(Local10));
	MaterialFloat Local12 = (DERIV_BASE_VALUE(Local11) * Material.PreshaderBuffer[1].z);
	MaterialFloat Local13 = PositiveClampedPow(DERIV_BASE_VALUE(Local12),Material.PreshaderBuffer[1].w);
	MaterialFloat Local14 = saturate(DERIV_BASE_VALUE(Local13));
	MaterialFloat3 Local15 = lerp(Local5,Local6,DERIV_BASE_VALUE(Local14));
	...
	MaterialFloat3 Local16 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].yzw,Material.PreshaderBuffer[2].x);
	MaterialFloat4 Local17 = Parameters.VertexColor;
	MaterialFloat Local18 = DERIV_BASE_VALUE(Local17).r;
	MaterialFloat3 Local19 = lerp(((MaterialFloat3)Material.PreshaderBuffer[4].w),Material.PreshaderBuffer[4].xyz,DERIV_BASE_VALUE(Local18));
	MaterialFloat Local20 = lerp(0.00000000,Material.PreshaderBuffer[5].x,DERIV_BASE_VALUE(Local18));
	MaterialFloat2 Local21 = (((MaterialFloat2)Material.PreshaderBuffer[5].y) * DERIV_BASE_VALUE(Local0));
	MaterialFloat Local22 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local21), 0);
	MaterialFloat4 Local23 = Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local21),View.MaterialTextureMipBias);
	MaterialFloat Local24 = MaterialStoreTexSample(Parameters, Local23, 0);
	MaterialFloat2 Local25 = (((MaterialFloat2)Material.PreshaderBuffer[5].z) * DERIV_BASE_VALUE(Local0));
	MaterialFloat Local26 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local25), 0);
	MaterialFloat4 Local27 = Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local25),View.MaterialTextureMipBias);
	MaterialFloat Local28 = MaterialStoreTexSample(Parameters, Local27, 0);
	MaterialFloat Local29 = lerp(Local23.r,Local27.r,DERIV_BASE_VALUE(Local14));
	MaterialFloat Local30 = lerp(Material.PreshaderBuffer[6].x,Material.PreshaderBuffer[5].w,Local29);
