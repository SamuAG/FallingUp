...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6] = float4(0.671875,0.671875,0.671875,0.500000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.945148,1.500000,0.966856,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.945148,1.500000,0.966856,2.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(1.000000,0.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.010000,1.000000,3.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(500.000000,250.000000,250.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(500.000000,250.000000,250.000000,0.200000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(3.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(0.202271,0.276042,0.172806,1.000000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(0.202271,0.276042,0.172806,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local16 = (Local3.rgb * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000),Parameters.TwoSidedSign));
	MaterialFloat3 Local17 = mul(Local16, Parameters.TangentToWorld);
	MaterialFloat Local18 = dot(Parameters.CameraVector,Local17);
	MaterialFloat Local19 = saturate(Local18);
	MaterialFloat Local20 = (Local19 * Material.PreshaderBuffer[6].w);
	MaterialFloat Local21 = (1.00000000 - Local20);
	MaterialFloat Local22 = (Local21 + 0.00000000);
	MaterialFloat3 Local23 = (((MaterialFloat3)Local22) * Local15);
	MaterialFloat Local24 = dot(Local15,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local25 = lerp(Local15,((MaterialFloat3)Local24),Material.PreshaderBuffer[7].x);
	MaterialFloat3 Local26 = (Local25 * Material.PreshaderBuffer[9].xyz);
	MaterialFloat Local27 = (1.00000000 - Local19);
	MaterialFloat Local28 = PositiveClampedPow(Local27,Material.PreshaderBuffer[9].w);
	MaterialFloat Local29 = (Local28 * Material.PreshaderBuffer[10].x);
	MaterialFloat Local30 = saturate(Local29);
	MaterialFloat3 Local31 = lerp(Local23,Local26,Local30);
	MaterialFloat3 Local32 = lerp(Local15,Local31,Local13.r);
	MaterialFloat Local33 = PositiveClampedPow(Local13.g,Material.PreshaderBuffer[10].z);
	MaterialFloat Local34 = (Material.PreshaderBuffer[10].w * Local13.r);
	MaterialFloat Local85 = PositiveClampedPow(Local13.r,Material.PreshaderBuffer[14].x);
	MaterialFloat3 Local86 = lerp(((MaterialFloat3)0.00000000),Local15,Local85);
	MaterialFloat3 Local87 = (Local86 * Material.PreshaderBuffer[16].xyz);
	MaterialFloat Local88 = (Local13.b * Material.PreshaderBuffer[17].x);
	...
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[10].y;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local33;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local6;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local87,Material.PreshaderBuffer[16].w);
	PixelMaterialInputs.AmbientOcclusion = Local88;
