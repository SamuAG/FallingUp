Shader "Unreal/MI_Desk_Wood"
{
	Properties
	{
		...
		Material_Texture2D_3( "L3AlbedoT", 2D ) = "white" {}
		Material_Texture2D_4( "L1MasksT", 2D ) = "white" {}
		Material_Texture2D_5( "L2MasksT", 2D ) = "white" {}
		Material_Texture2D_6( "L3MasksT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.338542,0.236533,0.190430,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,0.338542,0.236533,0.190430);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.833333,0.519741,0.323836,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,0.833333,0.519741,0.323836);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local8 = DERIV_BASE_VALUE(Local5).g;
	MaterialFloat3 Local9 = lerp(Local7,MaterialFloat3(0.00000000,0.00000000,1.00000000),DERIV_BASE_VALUE(Local8));
	...
	MaterialFloat3 Local10 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].y);
	MaterialFloat2 Local11 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[4].x));
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local11), 0);
	MaterialFloat4 Local13 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local11),View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local16 = (Material.PreshaderBuffer[4].yzw * ((MaterialFloat3)Local15));
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 0);
	MaterialFloat3 Local20 = lerp(Local16,Local18.rgb,DERIV_BASE_VALUE(Local6));
	MaterialFloat2 Local21 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[6].x));
	MaterialFloat Local22 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local21), 0);
	MaterialFloat4 Local23 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local21),View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local26 = (Material.PreshaderBuffer[6].yzw * ((MaterialFloat3)Local25));
	MaterialFloat3 Local27 = lerp(Local20,Local26,DERIV_BASE_VALUE(Local8));
	MaterialFloat Local28 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local11), 1);
	MaterialFloat4 Local29 = Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local11),View.MaterialTextureMipBias);
	MaterialFloat Local30 = MaterialStoreTexSample(Parameters, Local29, 1);
	MaterialFloat Local31 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local32 = Texture2DSampleBias(Material_Texture2D_5,Material_Texture2D_5Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local33 = MaterialStoreTexSample(Parameters, Local32, 1);
	MaterialFloat Local34 = lerp(Local29.r,Local32.r,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local35 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local21), 1);
	MaterialFloat4 Local36 = Texture2DSampleBias(Material_Texture2D_6,Material_Texture2D_6Sampler,DERIV_BASE_VALUE(Local21),View.MaterialTextureMipBias);
	MaterialFloat Local37 = MaterialStoreTexSample(Parameters, Local36, 1);
	MaterialFloat Local38 = lerp(Local34,Local36.r,DERIV_BASE_VALUE(Local8));
	MaterialFloat Local39 = lerp(Local29.g,Local32.g,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local40 = lerp(Local39,Local36.g,DERIV_BASE_VALUE(Local8));
	MaterialFloat Local41 = lerp(Local29.b,Local32.b,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local42 = lerp(Local41,Local36.b,DERIV_BASE_VALUE(Local8));

	PixelMaterialInputs.EmissiveColor = Local10;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local27.rgb;
	PixelMaterialInputs.Metallic = Local38.r;
