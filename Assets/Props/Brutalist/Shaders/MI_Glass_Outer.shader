...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(1.000000,1.500000,0.350000,0.019047);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.400000,1.500000,-0.500000,0.100000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.100000,0.500000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local1 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	MaterialFloat2 Local2 = Parameters.TexCoords[0].xy;
	MaterialFloat2 Local3 = (DERIV_BASE_VALUE(Local2) * ((MaterialFloat2)Material.PreshaderBuffer[4].y));
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local3), 0);
	MaterialFloat4 Local5 = Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local3),View.MaterialTextureMipBias);
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 0);
	MaterialFloat Local7 = lerp(Material.PreshaderBuffer[4].w,Material.PreshaderBuffer[4].z,Local5.rgb.g);
	MaterialFloat Local8 = dot(Local0,Parameters.CameraVector);
	...
	MaterialFloat Local13 = PositiveClampedPow(Local12,Material.PreshaderBuffer[5].x);
	MaterialFloat Local14 = (Local13 * Material.PreshaderBuffer[5].z);
	MaterialFloat Local15 = (Local14 + Material.PreshaderBuffer[5].y);
	MaterialFloat Local16 = lerp(Material.PreshaderBuffer[6].x,Material.PreshaderBuffer[5].w,Local15);
	MaterialFloat Local17 = lerp(Material.PreshaderBuffer[6].y,Local16,Material.PreshaderBuffer[6].y);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[6].z);
