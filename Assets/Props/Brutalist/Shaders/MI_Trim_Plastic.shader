...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,3.000000,0.500000,5.554473);//(Unknown)
	Material.PreshaderBuffer[2] = float4(2.777236,-2.100000,-4.877236,256.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(256.000000,-256.000000,-0.003906,1.215962);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.434449,1.500000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(0.651042,0.651042,0.651042,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.880208,0.880208,0.880208,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.880208,0.880208,0.880208,1.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.072917,0.070441,0.058912,1.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.072917,0.070441,0.058912,0.300000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(0.372917,0.370441,0.358912,0.400000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local33 = lerp(Local23.rgb,Local28.rgb,Local32.r.r);
	...
	MaterialFloat3 Local42 = lerp(Local33,Local37.rgb,Local41.r.r);
	MaterialFloat3 Local43 = (Local42 * ((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat3 Local44 = PositiveClampedPow(Local43,((MaterialFloat3)Material.PreshaderBuffer[4].x));
	MaterialFloat3 Local45 = saturate(Local44);
	MaterialFloat Local46 = PositiveClampedPow(Local45.r,Material.PreshaderBuffer[4].y);
	...
	MaterialFloat3 Local51 = lerp(Local3.rgb,Local9,Local50);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local51.rgb;
	...
	MaterialFloat3 Local52 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[5].xyz,Material.PreshaderBuffer[4].z);
	MaterialFloat Local53 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local54 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local55 = MaterialStoreTexSample(Parameters, Local54, 0);
	MaterialFloat Local56 = dot(Local54.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local57 = (Material.PreshaderBuffer[7].xyz * ((MaterialFloat3)Local56));
	MaterialFloat Local58 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local59 = Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local60 = MaterialStoreTexSample(Parameters, Local59, 1);
	MaterialFloat3 Local61 = lerp(Local54.rgb,Local57,Local59.a);
	MaterialFloat3 Local62 = (Material.PreshaderBuffer[9].xyz * Local61);
	MaterialFloat Local63 = (Material.PreshaderBuffer[9].w * Local45.g);
	MaterialFloat Local64 = saturate(Local63);
	MaterialFloat4 Local65 = Parameters.VertexColor;
	MaterialFloat Local66 = DERIV_BASE_VALUE(Local65).r;
	MaterialFloat Local67 = DERIV_BASE_VALUE(Local65).g;
	MaterialFloat Local68 = (DERIV_BASE_VALUE(Local66) + DERIV_BASE_VALUE(Local67));
	MaterialFloat Local69 = (1.00000000 - DERIV_BASE_VALUE(Local68));
	MaterialFloat Local70 = (DERIV_BASE_VALUE(Local69) + DERIV_BASE_VALUE(Local66));
	MaterialFloat Local71 = (DERIV_BASE_VALUE(Local70) + DERIV_BASE_VALUE(Local67));
	MaterialFloat Local72 = lerp(0.00000000,Local64,DERIV_BASE_VALUE(Local71));
	MaterialFloat3 Local73 = lerp(Local61,Local62,Local72);
	MaterialFloat Local74 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 11);
	MaterialFloat4 Local75 = Texture2DSampleBias(Material_Texture2D_5,Material_Texture2D_5Sampler,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias);
	MaterialFloat Local76 = MaterialStoreTexSample(Parameters, Local75, 11);
	MaterialFloat3 Local77 = lerp(Material.PreshaderBuffer[11].xyz,Material.PreshaderBuffer[12].xyz,Local75.g);
	MaterialFloat3 Local78 = lerp(Local73,Local77,Local50);
	MaterialFloat Local79 = lerp(Local59.r,0.00000000,Local50);
	MaterialFloat Local80 = max(Local59.g,Material.PreshaderBuffer[12].w);
	MaterialFloat Local81 = min(Local80,Material.PreshaderBuffer[13].x);
	MaterialFloat Local82 = lerp(Local59.g,Local81,Local72);
	MaterialFloat Local83 = lerp(Local82,Material.PreshaderBuffer[13].y,Local50);
	MaterialFloat Local84 = lerp(Local59.b,1.00000000,Local50);

	PixelMaterialInputs.EmissiveColor = Local52;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local78.rgb;
	PixelMaterialInputs.Metallic = Local79.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local83.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local51.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local84.r;
