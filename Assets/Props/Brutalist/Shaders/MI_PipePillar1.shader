Shader "Unreal/MI_PipePillar1"
{
	Properties
	{
		...
		Material_Texture2D_2( "L1MasksT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(0.401042,0.377612,0.365533,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.401042,0.377612,0.365533,1500.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1500.000000,-1500.000000,-0.000667,0.661137);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.679711,2.000000,1.000000,0.350000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.809252,1.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local14 = lerp(Local7.rgb,Local10,Local12.a);
	MaterialFloat3 Local15 = (Material.PreshaderBuffer[6].xyz * Local14);
	FLWCVector3 Local16 = GetWorldPosition_NoMaterialOffsets(Parameters);
	FLWCVector3 Local17 = LWCMultiply(DERIV_BASE_VALUE(Local16), LWCPromote(((MaterialFloat3)Material.PreshaderBuffer[7].z)));
	...
	MaterialFloat3 Local41 = (Local40 * ((MaterialFloat3)Material.PreshaderBuffer[7].w));
	MaterialFloat3 Local42 = PositiveClampedPow(Local41,((MaterialFloat3)Material.PreshaderBuffer[8].x));
	MaterialFloat3 Local43 = saturate(Local42);
	MaterialFloat Local44 = (Material.PreshaderBuffer[8].y * Local43.g);
	...
	MaterialFloat Local48 = DERIV_BASE_VALUE(Local46).g;
	MaterialFloat Local49 = (DERIV_BASE_VALUE(Local47) + DERIV_BASE_VALUE(Local48));
	MaterialFloat Local50 = (1.00000000 - DERIV_BASE_VALUE(Local49));
	MaterialFloat Local51 = (DERIV_BASE_VALUE(Local50) + DERIV_BASE_VALUE(Local47));
	MaterialFloat Local52 = (DERIV_BASE_VALUE(Local51) + DERIV_BASE_VALUE(Local48));
	MaterialFloat Local53 = lerp(0.00000000,Local45,DERIV_BASE_VALUE(Local52));
	MaterialFloat3 Local54 = lerp(Local14,Local15,Local53);
	MaterialFloat Local55 = max(Material.PreshaderBuffer[8].w,Material.PreshaderBuffer[9].x);
	MaterialFloat Local56 = min(Local55,Material.PreshaderBuffer[9].y);
	MaterialFloat Local57 = lerp(Material.PreshaderBuffer[8].w,Local56,Local53);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local54.rgb;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[8].z.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local57.r;
