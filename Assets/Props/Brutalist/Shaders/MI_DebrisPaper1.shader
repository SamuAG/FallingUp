Shader "Unreal/MI_DebrisPaper1"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "AlbedoT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,0.000000,0.000000,0.800000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.800000,1.000000,1.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(0.00000000.rrr,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
	...
	PixelMaterialInputs.AmbientOcclusion = Material.PreshaderBuffer[3].z;
