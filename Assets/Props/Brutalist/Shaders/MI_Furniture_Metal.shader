Shader "Unreal/MI_Furniture_Metal"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.536458,0.536458,0.536458,0.276190);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.304762,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local14 = max(Local12.g,Material.PreshaderBuffer[4].w);
	MaterialFloat Local15 = min(Local14,Material.PreshaderBuffer[5].x);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local10.rgb;
	PixelMaterialInputs.Metallic = Local12.r.r;
	...
	PixelMaterialInputs.AmbientOcclusion = Local12.b.r;
