...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.739583,0.739583,0.739583,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.739583,0.739583,0.739583,1500.000000);//(Unknown)
	...
	Material.PreshaderBuffer[8] = float4(0.117137,0.173073,0.234375,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.117137,0.173073,0.234375,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[16] = float4(0.000000,1.000000,0.673810,0.800000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(0.500000,0.410000,0.850000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local99 = lerp(Material.PreshaderBuffer[15].w,Material.PreshaderBuffer[16].x,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local100 = lerp(DERIV_BASE_VALUE(Local99),Material.PreshaderBuffer[16].y,DERIV_BASE_VALUE(Local16));
	MaterialFloat Local101 = DERIV_BASE_VALUE(Local100).r;
	MaterialFloat Local102 = lerp(Material.PreshaderBuffer[16].z,Material.PreshaderBuffer[16].w,Local62);
	MaterialFloat Local103 = lerp(Local102,Material.PreshaderBuffer[17].x,DERIV_BASE_VALUE(Local10));
	MaterialFloat Local104 = lerp(Local103,Material.PreshaderBuffer[17].y,DERIV_BASE_VALUE(Local16));
	MaterialFloat Local105 = lerp(Local104,Material.PreshaderBuffer[17].z,Local97);

	PixelMaterialInputs.EmissiveColor = Local18;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local98.rgb;
	PixelMaterialInputs.Metallic = Local101;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local105.r;
