...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.197917,0.197917,0.197917,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.197917,0.197917,0.197917,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local2 = (DERIV_BASE_VALUE(Local1) * ((MaterialFloat2)Material.PreshaderBuffer[2].x));
	...
	MaterialFloat3 Local7 = (Material.PreshaderBuffer[4].xyz * ((MaterialFloat3)Local6));
	...
	MaterialFloat3 Local11 = lerp(Local4.rgb,Local7,Local9.a);
	...
	PixelMaterialInputs.Roughness = Local9.g.r;
