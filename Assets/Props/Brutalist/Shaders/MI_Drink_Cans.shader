Shader "Unreal/MI_Drink_Cans"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "NormalT", 2D ) = "white" {}
		Material_Texture2D_1( "AlbedoT", 2D ) = "white" {}
		Material_Texture2D_2( "RandomColorPalette", 2D ) = "white" {}
		Material_Texture2D_3( "MasksT", 2D ) = "white" {}
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = lerp(0.00000000.rrr,Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].y);
	...
	MaterialFloat Local9 = (GetPerInstanceRandom(Parameters) * 3.00000000);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local9,0.50000000), 6);
	MaterialFloat4 Local11 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,MaterialFloat2(Local9,0.50000000),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 6);
	MaterialFloat3 Local13 = lerp(Local7.rgb,Local11.rgb,Material.PreshaderBuffer[2].w);
	MaterialFloat4 Local14 = Parameters.VertexColor;
	MaterialFloat Local15 = DERIV_BASE_VALUE(Local14).r;
	MaterialFloat3 Local16 = lerp(Local7.rgb,Local13,DERIV_BASE_VALUE(Local15));
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local18 = Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 1);
	MaterialFloat Local20 = (Local18.g * Material.PreshaderBuffer[3].x);
	MaterialFloat Local21 = PositiveClampedPow(Local20,Material.PreshaderBuffer[3].y);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local16.rgb;
	PixelMaterialInputs.Metallic = Local18.r.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local21.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local3.rgb.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local18.b.r;
