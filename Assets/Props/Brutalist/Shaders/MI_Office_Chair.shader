Shader "Unreal/MI_Office_Chair"
{
	Properties
	{
		...
		Material_Texture2D_2( "MasksT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.089627,0.145833,0.113572,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.089627,0.145833,0.113572,1.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local12 = lerp(Local7.rgb,Local9,DERIV_BASE_VALUE(Local11));
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local14 = Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 1);
	MaterialFloat Local16 = (Local14.g * Material.PreshaderBuffer[4].w);
	MaterialFloat Local17 = PositiveClampedPow(Local16,Material.PreshaderBuffer[5].x);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local12.rgb;
	PixelMaterialInputs.Metallic = Local14.r.r;
	...
	PixelMaterialInputs.AmbientOcclusion = Local14.b.r;
