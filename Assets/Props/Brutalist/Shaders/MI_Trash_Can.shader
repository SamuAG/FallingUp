...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.536458,0.536458,0.536458,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(3.000000,0.536458,0.536458,0.536458);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(99.454552,32.598141,-66.856415,-0.014957);//(Unknown)
	Material.PreshaderBuffer[7] = float4(256.000000,256.000000,-256.000000,-0.003906);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.295816,0.700000,1.231199,0.161904);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000000,0.000000,0.000000,0.238095);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.400000,0.249999,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	FLWCVector3 Local19 = GetWorldPosition_NoMaterialOffsets(Parameters);
	FLWCVector3 Local20 = LWCSubtract(DERIV_BASE_VALUE(Local19), GetActorWorldPosition(Parameters));
	MaterialFloat3 Local21 = LWCToFloat(DERIV_BASE_VALUE(Local20));
	...
	MaterialFloat Local24 = (DERIV_BASE_VALUE(Local23) * Material.PreshaderBuffer[6].w);
	MaterialFloat Local25 = saturate(DERIV_BASE_VALUE(Local24));
	FLWCVector3 Local26 = LWCMultiply(DERIV_BASE_VALUE(Local19), LWCPromote(((MaterialFloat3)Material.PreshaderBuffer[7].w)));
	...
	MaterialFloat3 Local50 = (Local49 * ((MaterialFloat3)Material.PreshaderBuffer[8].x));
	MaterialFloat3 Local51 = PositiveClampedPow(Local50,((MaterialFloat3)Material.PreshaderBuffer[8].y));
	MaterialFloat3 Local52 = saturate(Local51);
	MaterialFloat Local53 = PositiveClampedPow(Local52.g,Material.PreshaderBuffer[8].z);
	MaterialFloat Local54 = (DERIV_BASE_VALUE(Local25) * Local53);
	MaterialFloat Local55 = max(Local54,0.00000000);
	MaterialFloat Local56 = min(Local55,Material.PreshaderBuffer[8].w);
	MaterialFloat Local57 = dot(Parameters.TangentToWorld[2],MaterialFloat3(0.00000000,0.00000000,1.00000000));
	MaterialFloat Local58 = PositiveClampedPow(Local57,5.00000000);
	MaterialFloat Local59 = lerp(1.00000000,-1.00000000,Local58);
	MaterialFloat Local60 = saturate(Local59);
	MaterialFloat Local61 = (Local56 * Local60);
	MaterialFloat3 Local62 = lerp(Local18,Material.PreshaderBuffer[9].xyz,Local61);
	MaterialFloat Local63 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local9), 1);
	MaterialFloat4 Local64 = Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local9),View.MaterialTextureMipBias);
	...
	MaterialFloat Local69 = lerp(Local64.r,Local67.r,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local70 = max(Local64.g,Material.PreshaderBuffer[9].w);
	MaterialFloat Local71 = min(Local70,Material.PreshaderBuffer[10].x);
	MaterialFloat Local72 = lerp(Local71,Local67.g,DERIV_BASE_VALUE(Local6));
	MaterialFloat Local73 = lerp(Local72,Material.PreshaderBuffer[10].y,Local61);
	MaterialFloat Local74 = lerp(Local64.b,Local67.b,DERIV_BASE_VALUE(Local6));

	PixelMaterialInputs.EmissiveColor = Local8;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local62.rgb;
	PixelMaterialInputs.Metallic = Local69.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local73.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local7.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local74.r;
