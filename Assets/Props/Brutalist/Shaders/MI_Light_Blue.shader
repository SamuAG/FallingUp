Shader "Unreal/MI_Light_Blue"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "LightMask", 2D ) = "white" {}
		Material_Texture2D_1( "DetailMap", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.099998,0.444961,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.099998,0.444961,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.104167,0.104167,0.104167,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.104167,0.104167,0.104167,3.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(2.000000,2.000000,3.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local3 = Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local4 = MaterialStoreTexSample(Parameters, Local3, 2);
	MaterialFloat4 Local5 = Parameters.VertexColor;
	MaterialFloat3 Local6 = DERIV_BASE_VALUE(Local5).rgb;
	MaterialFloat3 Local7 = (((MaterialFloat3)Local3.r) * DERIV_BASE_VALUE(Local6));
	MaterialFloat3 Local8 = (Local7 * Material.PreshaderBuffer[3].xyz);
	MaterialFloat3 Local9 = (Local8 * ((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat3 Local10 = lerp(Local9,Material.PreshaderBuffer[4].yzw,Material.PreshaderBuffer[4].x);
	MaterialFloat Local11 = PositiveClampedPow(Local3.g,5.00000000);
	MaterialFloat3 Local12 = (Material.PreshaderBuffer[6].xyz * ((MaterialFloat3)Local11));
	MaterialFloat2 Local13 = (DERIV_BASE_VALUE(Local0) * Material.PreshaderBuffer[7].yz);
	MaterialFloat Local14 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local13), 0);
	MaterialFloat4 Local15 = Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local13),View.MaterialTextureMipBias);
