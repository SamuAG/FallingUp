Shader "Unreal/MI_Merged_Build1"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "T_PaintedWallRough_N", 2D ) = "white" {}
		Material_Texture2D_1( "Masks", 2D ) = "white" {}
		Material_Texture2D_2( "RandomColorPalette", 2D ) = "white" {}
		Material_Texture2D_3( "BaseColor", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(5.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.300000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.250000,0.850000,3.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local6 = Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local7 = MaterialStoreTexSample(Parameters, Local6, 1);
	MaterialFloat3 Local8 = lerp(Local3.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Local6.r);
	...
	MaterialFloat3 Local9 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].y);
	MaterialFloat Local10 = (GetPerInstanceRandom(Parameters) * 3.00000000);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local10,0.50000000), 3);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,MaterialFloat2(Local10,0.50000000),View.MaterialTextureMipBias));
	...
	MaterialFloat3 Local17 = (Local12.rgb * Local15.rgb);
	MaterialFloat3 Local18 = lerp(Local17,Local15.rgb,Material.PreshaderBuffer[2].w);
	MaterialFloat3 Local19 = lerp(Local18,Local15.rgb,Local6.r);
	MaterialFloat3 Local20 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Local19,Local6.b);
	MaterialFloat Local21 = lerp(Material.PreshaderBuffer[3].y,Material.PreshaderBuffer[3].x,Local6.r);
	MaterialFloat Local22 = (1.00000000 - Local6.b);
	MaterialFloat Local23 = (Local21 + Local22);
	MaterialFloat Local24 = PositiveClampedPow(Local6.b,Material.PreshaderBuffer[3].z);
