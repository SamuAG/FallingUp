Shader "Unreal/MI_Fern"
{
	Properties
	{
		...
		Material_Texture2D_0( "BaseNormalT", 2D ) = "white" {}
		Material_Texture2D_1( "BaseAlbedoTex", 2D ) = "white" {}
		Material_Texture2D_2( "FoliageMasks", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[7] = float4(0.672723,1.000000,0.465086,1.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.672723,1.000000,0.465086,1.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.537191,1.000000,0.830674,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.537191,1.000000,0.830674,2.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(1.000000,0.000000,2.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[13] = float4(0.452381,1.997604,0.200000,0.000000);//(Unknown)
	Material.PreshaderBuffer[14] = float4(20.000000,20.000000,20.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[15] = float4(20.000000,20.000000,20.000000,0.200000);//(Unknown)
	Material.PreshaderBuffer[16] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[17] = float4(0.786458,0.598198,0.188422,1.000000);//(Unknown)
	Material.PreshaderBuffer[18] = float4(0.786458,0.598198,0.188422,0.000000);//(Unknown)
	Material.PreshaderBuffer[19] = float4(1.000000,0.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (((MaterialFloat2)Material.PreshaderBuffer[1].x) * DERIV_BASE_VALUE(Local0));
	...
	MaterialFloat3 Local6 = (Local5 * ((MaterialFloat3)Parameters.TwoSidedSign));
	...
	MaterialFloat3 Local7 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[4].xyz,Material.PreshaderBuffer[3].w);
	...
	MaterialFloat3 Local11 = (Local9.rgb * Material.PreshaderBuffer[6].xyz);
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	...
	MaterialFloat3 Local15 = lerp(Local9.rgb,Local11,Local13.r);
	MaterialFloat3 Local16 = (Local15 * Material.PreshaderBuffer[8].xyz);
	MaterialFloat3 Local17 = lerp(Local15,Local16,GetPerInstanceRandom(Parameters));
	MaterialFloat3 Local18 = (Local3.rgb * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000),Parameters.TwoSidedSign));
	MaterialFloat3 Local19 = mul(Local18, Parameters.TangentToWorld);
	MaterialFloat Local20 = dot(Parameters.CameraVector,Local19);
	MaterialFloat Local21 = saturate(Local20);
	MaterialFloat Local22 = (Local21 * Material.PreshaderBuffer[8].w);
	MaterialFloat Local23 = (1.00000000 - Local22);
	MaterialFloat Local24 = (Local23 + 0.00000000);
	MaterialFloat3 Local25 = (((MaterialFloat3)Local24) * Local17);
	MaterialFloat Local26 = dot(Local17,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local27 = lerp(Local17,((MaterialFloat3)Local26),Material.PreshaderBuffer[9].x);
	MaterialFloat3 Local28 = (Local27 * Material.PreshaderBuffer[11].xyz);
	MaterialFloat Local29 = (1.00000000 - Local21);
	MaterialFloat Local30 = PositiveClampedPow(Local29,Material.PreshaderBuffer[11].w);
	MaterialFloat Local31 = (Local30 * Material.PreshaderBuffer[12].x);
	MaterialFloat Local32 = saturate(Local31);
	MaterialFloat3 Local33 = lerp(Local25,Local28,Local32);
	MaterialFloat3 Local34 = lerp(Local17,Local33,Local13.r);
	MaterialFloat Local35 = PositiveClampedPow(Local13.g,Material.PreshaderBuffer[12].z);
	MaterialFloat Local36 = (Material.PreshaderBuffer[12].w * Local13.r);
	MaterialFloat Local89 = PositiveClampedPow(Local13.r,Material.PreshaderBuffer[16].x);
	MaterialFloat3 Local90 = lerp(((MaterialFloat3)0.00000000),Local17,Local89);
	MaterialFloat3 Local91 = (Local90 * Material.PreshaderBuffer[18].xyz);
	MaterialFloat Local92 = (Local13.b * Material.PreshaderBuffer[19].x);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = Local36;
	PixelMaterialInputs.OpacityMask = Local9.a;
	PixelMaterialInputs.BaseColor = Local34;
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[12].y;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local35;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local6;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local91,Material.PreshaderBuffer[18].w);
	PixelMaterialInputs.AmbientOcclusion = Local92;
