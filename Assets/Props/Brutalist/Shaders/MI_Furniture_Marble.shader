Shader "Unreal/MI_Furniture_Marble"
{
	Properties
	{
		...
		Material_Texture2D_3( "L1MasksT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.072917,0.072917,0.072917,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.072917,0.072917,0.072917,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.317708,0.317708,0.317708,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.317708,0.317708,0.317708,1500.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1500.000000,-1500.000000,-0.000667,0.242211);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.300990,0.300000,0.400000,1500.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.000667,3.000000,0.000000,0.200000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.750000,1.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local27 = lerp(MaterialFloat4(Local17.rgb,Local17.a),MaterialFloat4(Local22.rgb,Local22.a),Local26.r.r);
	...
	MaterialFloat4 Local36 = lerp(Local27,MaterialFloat4(Local31.rgb,Local31.a),Local35.r.r);
	MaterialFloat4 Local37 = (Local36 * ((MaterialFloat4)Material.PreshaderBuffer[7].w));
	MaterialFloat4 Local38 = PositiveClampedPow(Local37,((MaterialFloat4)Material.PreshaderBuffer[8].x));
	MaterialFloat4 Local39 = saturate(Local38);
	...
	MaterialFloat Local51 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local52 = Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local53 = MaterialStoreTexSample(Parameters, Local52, 1);
	MaterialFloat2 Local54 = (DERIV_BASE_VALUE(Local0) * ((MaterialFloat2)Material.PreshaderBuffer[8].z));
	MaterialFloat Local55 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local54), 1);
	MaterialFloat4 Local56 = Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local54),View.MaterialTextureMipBias);
	MaterialFloat Local57 = MaterialStoreTexSample(Parameters, Local56, 1);
	FLWCVector3 Local58 = GetWorldPosition(Parameters);
	FLWCVector3 Local59 = ResolvedView.WorldCameraOrigin;
	FLWCVector3 Local60 = LWCSubtract(DERIV_BASE_VALUE(Local58), Local59);
	MaterialFloat3 Local61 = LWCToFloat(DERIV_BASE_VALUE(Local60));
	MaterialFloat Local62 = length(DERIV_BASE_VALUE(Local61));
	MaterialFloat Local63 = (DERIV_BASE_VALUE(Local62) * Material.PreshaderBuffer[9].x);
	MaterialFloat Local64 = PositiveClampedPow(DERIV_BASE_VALUE(Local63),Material.PreshaderBuffer[9].y);
	MaterialFloat Local65 = saturate(DERIV_BASE_VALUE(Local64));
	MaterialFloat Local66 = lerp(Local52.g,Local56.g,DERIV_BASE_VALUE(Local65));
	MaterialFloat Local67 = max(Local66,Material.PreshaderBuffer[9].z);
	MaterialFloat Local68 = min(Local67,Material.PreshaderBuffer[9].w);
	MaterialFloat Local69 = max(Local68,Material.PreshaderBuffer[10].x);
	MaterialFloat Local70 = min(Local69,Material.PreshaderBuffer[10].y);
	MaterialFloat Local71 = lerp(Local68,Local70,Local49);

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local50.rgb;
	PixelMaterialInputs.Metallic = Local52.r.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local71.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local3.rgb.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local52.b.r;
