Shader "Unreal/MI_Spruce_Trunk"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "Layer1NormalT", 2D ) = "white" {}
		Material_Texture2D_1( "Layer2NormalT", 2D ) = "white" {}
		Material_Texture2D_2( "Layer1MasksT", 2D ) = "white" {}
		Material_Texture2D_3( "Layer1AlbedoT", 2D ) = "white" {}
		Material_Texture2D_4( "Layer2AlbedoT", 2D ) = "white" {}
		Material_Texture2D_5( "Layer2MasksT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(2.000000,2.000000,15.459985,61.097649);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.525174,0.630208,0.420139,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.525174,0.630208,0.420139,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.708333,0.708333,0.708333,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.708333,0.708333,0.708333,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 3);
	...
	MaterialFloat4 Local12 = Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 4);
	MaterialFloat Local14 = (DERIV_BASE_VALUE(Local10) * Local12.r);
	MaterialFloat Local15 = (Local14 * Material.PreshaderBuffer[1].z);
	MaterialFloat Local16 = PositiveClampedPow(Local15,Material.PreshaderBuffer[1].w);
	MaterialFloat Local17 = saturate(Local16);
	MaterialFloat3 Local18 = lerp(Local3.rgb,Local7.rgb,Local17);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = Local18.rgb;
	...
	MaterialFloat3 Local19 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].yzw,Material.PreshaderBuffer[2].x);
	MaterialFloat Local20 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local21 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 0);
	MaterialFloat3 Local23 = (Material.PreshaderBuffer[4].xyz * Local21.rgb);
	MaterialFloat Local24 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 2);
	MaterialFloat4 Local25 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias));
	MaterialFloat Local26 = MaterialStoreTexSample(Parameters, Local25, 2);
	MaterialFloat3 Local27 = (Material.PreshaderBuffer[6].xyz * Local25.rgb);
	MaterialFloat3 Local28 = lerp(Local23,Local27,Local17);
	MaterialFloat Local29 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local5), 5);
	MaterialFloat4 Local30 = Texture2DSampleBias(Material_Texture2D_5,Material_Texture2D_5Sampler,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias);
	MaterialFloat Local31 = MaterialStoreTexSample(Parameters, Local30, 5);
	MaterialFloat Local32 = lerp(Local12.g,Local30.g,Local17);
	MaterialFloat Local33 = lerp(Local12.b,Local30.b,Local17);

	PixelMaterialInputs.EmissiveColor = Local19;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local28.rgb;
	PixelMaterialInputs.Metallic = 0.00000000.r;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local32.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local18.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local33.r;
