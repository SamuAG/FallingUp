Shader "Unreal/MI_Spruce_Leaves"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,0.500000,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,0.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.665397,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.447912,1.000000,0.585937,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.447912,1.000000,0.585937,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local14 = PositiveClampedPow(Local12.g,Material.PreshaderBuffer[5].x);
	MaterialFloat Local15 = (Material.PreshaderBuffer[5].y * Local12.r);
	MaterialFloat Local16 = PositiveClampedPow(Local12.r,Material.PreshaderBuffer[5].z);
	MaterialFloat3 Local17 = lerp(((MaterialFloat3)0.00000000),Local9.rgb,Local16);
	MaterialFloat3 Local18 = (Local17 * Material.PreshaderBuffer[7].xyz);
	MaterialFloat Local19 = (Local12.b * Material.PreshaderBuffer[8].x);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = Local15;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local18,Material.PreshaderBuffer[7].w);
