Shader "Unreal/MI_Light_Switch"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "L1AlbedoT", 2D ) = "white" {}
		Material_Texture2D_1( "L1MasksT", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.703125,0.703125,0.703125,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,0.703125,0.703125,0.703125);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.304762,1.000000,0.000000,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = dot(Local4.rgb,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local7 = (Material.PreshaderBuffer[3].yzw * ((MaterialFloat3)Local6));
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 1);
	MaterialFloat4 Local9 = Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 1);
	MaterialFloat Local11 = max(Local9.g,Material.PreshaderBuffer[4].x);
	MaterialFloat Local12 = min(Local11,Material.PreshaderBuffer[4].y);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local7.rgb;
	PixelMaterialInputs.Metallic = Local9.r.r;
	...
	PixelMaterialInputs.AmbientOcclusion = Local9.b.r;
