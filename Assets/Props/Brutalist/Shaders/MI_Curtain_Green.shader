Shader "Unreal/MI_Curtain_Green"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "BaseNormalT", 2D ) = "white" {}
		Material_Texture2D_1( "DetailNormalT", 2D ) = "white" {}
		Material_Texture2D_2( "FabricMasks", 2D ) = "white" {}
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.714286,4.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.074510,0.117647,0.101961,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.083333,0.083333,0.083333,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1.000000,0.083333,0.083333,0.083333);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.074510,0.117647,0.101961,0.750000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(0.600000,1.000000,0.300000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.074510,0.117647,0.101961,0.000000);//(Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local6 = (((MaterialFloat2)Material.PreshaderBuffer[1].z) * DERIV_BASE_VALUE(Local0));
	MaterialFloat Local7 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local6), 6);
	MaterialFloat4 Local8 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local6),View.MaterialTextureMipBias));
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 6);
	MaterialFloat3 Local10 = (Local8.rgb * Material.PreshaderBuffer[3].xyz);
	MaterialFloat3 Local11 = (Local10 * MaterialFloat3(1.00000000,1.00000000,0.00000000));
	...
	MaterialFloat4 Local16 = Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 0);
	MaterialFloat Local18 = (Local16.r * Material.PreshaderBuffer[7].x);
	MaterialFloat Local19 = saturate(Local18);
	MaterialFloat3 Local20 = lerp(Material.PreshaderBuffer[8].xyz,Material.PreshaderBuffer[7].yzw,Local19);
	MaterialFloat3 Local21 = lerp(Material.PreshaderBuffer[10].xyz,((MaterialFloat3)Material.PreshaderBuffer[9].z),Local20);

	PixelMaterialInputs.EmissiveColor = Local14;
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[9].x;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local21,Material.PreshaderBuffer[10].w);
